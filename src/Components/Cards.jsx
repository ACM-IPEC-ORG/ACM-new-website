  ...
  const [a,seta]=useState(0)
    ...
    return(
      ...
      className="grid grid-flow-row w-42 place-items-center p-2">
          <div className="bg-gray-500 overflow-hidden p-24 border border-48 border-sky-400 rounded-full shadow-2xl"
           style={{
...
export const UpcomingCard=function(props){
  return(
    <div className="md:sticky w-full aspect-square top-[10vh] rounded-3xl " style={{
      backgroundImage:`url(${props.img})`,
      backgroundPosition:"center",
...
export const Founder=function(props){
  const [a,seta]=useState(0)
    ...
    return(
      ...
      whileHover={{scale:1.1}}  onHoverStart={()=>seta(1)} onHoverEnd={()=>seta(0)}
      className="grid grid-flow-row w-42 place-items-center p-2">
          <div className="bg-gray-500 overflow-hidden p-20 border border-48 border-sky-400 rounded-full shadow-2xl"
           style={{
            backgroundImage:`url(${props.img})`,
            backgroundPosition:"center",
            backgroundRepeat:"no-repeat",
  ...
  const [a,seta]=useState(0)
    return(
      <div className="">
        ...
        whileHover={{scale:1.1}} onHoverStart={()=>seta(1)} onHoverEnd={()=>seta(0)}
        className="grid grid-flow-row w-42 place-items-center p-2">
            <div className="bg-gray-500 overflow-hidden p-14 rounded-full shadow-2xl"
             style={{
              backgroundImage:`url(${props.img})`,
              backgroundPosition:"center",
              backgroundRepeat:"no-repeat",
            ...
            {cards.map((_, index) => (
              <button
                ...
                className={`w-4 h-4 mx-2 rounded-full ${
                  index === currentCardIndex ? 'bg-gray-800' : 'bg-gray-400'
                }`}
