...
export const session_2022_23 = [
  {
    ...
    intro:
      " IPEC ACM STUDENT CHAPTER is organizing AIPICATHON An event for 1st year and 3rd year students BBA, BCA,  Btech branches (CSE, CSE(DS), CSE(AIML), IT ).AIPICATHON: A Multi Elimination round  event  to merge innovation with imagination that portray in AI image",
    info: "Generate AI images with the following rounds: Round 1: Based on theme., Round 2: Using Keyword., Participants will be judged based on different categories as follows Element consistency in AI images.Attractive theme portray. Imagination with Artificial Intelligence.",
    rules: [
    ...
    cno: ["Eti: +91 8218553892", "Tanish: +91 8382874059"],
  },
  {
    id: "1",
    tags: "s22_23",
  ...
  },
  {
    ...
    intro:
      "Welcome to BrainBrew, the ultimate mental workout for tech enthusiasts! This event is a tantalizing concoction of crossword questions designed to challenge your knowledge of basic programming, algorithms, and more. It's the perfect opportunity to test your tech-savvy skills and brew up some genius solutions.",
    heading: "BrainBrew",
    slugs: "BrainBrew",
    winners: [],
    rules: [
  ...
  },
  {
    ...
    intro:
      "Welcome to ABCD - Anybody Can Design, the ultimate celebration of creativity and design prowess! In this exciting event, participants will harness their design skills to create captivating user interfaces based on a selection of intriguing themes. From EdTech to E-Commerce, it's an open canvas where your imagination knows no bounds. Get ready to design, innovate, and showcase your creative genius at ABCD!",
...
export const allEvent = [
  ...
  },
  {
    ...
    slugs: "15DOS",
    intro:
      "Join us for '15 Days of Open Source,' an exciting event organized in collaboration with Trinity Cyber Forum. This initiative aims to foster a vibrant culture of open source within our college community. Over the course of 15 days, participants will embark on a journey into the world of open-source software, contributing to projects, learning from experts, and embracing the ethos of collaboration. It's not just an event; it's a movement to ignite the open-source spirit within our college.",
  ...
  },
  {
    ...
    tags: "s20_21",
    intro:
      "Get ready for an exhilarating programming challenge at Codeathon 3.0! This event is your chance to showcase your programming skills, problem-solving prowess, and coding creativity. Dive into a series of coding challenges that will test your mettle, from beginners looking to hone their skills to seasoned coders seeking to prove their expertise. Codeathon 3.0 is not just a competition; it's a platform to unleash your programming potential, conquer challenges, and make your code speak volumes.",
    winners: [],
    rules: [
