...
export default function Footer() {
    return (
        <div className="w-full bg-black py-4 text-gray-400 px-24 divide-y-2 divide-gray-500">
        <div className="grid xl:grid-cols-2 lg:grid-cols-1 grid-cols-1 h-full  py-10 text-gray-400">
            <div className="grid lg:grid-cols-[20rem_30rem] divide-x-2 divide-gray-400">
                <Link to="/"><div className="p-12" style={{
                ...
                <div className="px-5 grid grid-cols-1 justify-center">
                    <ul className="lg:flex grid md:gap-4 lg:gap-10 gap-2 text-white pt-4 ">
                ...
                <h5 className="py-4 lg:py-0">@2023 IPEC ACM. All Rights are Reserved</h5>
            ...
            <div className="grid grid-rows-2 justify-end ">
                ...
                <h5 className="text-center">contact: ipecacm@gmail.com</h5>
            </div>
        </div>
        </div>
    )
