        ...
        <div>
            ...
            <motion.div className="Team-Hero py-10" style={{y}}>
                ...
                <div className="text-center xl:py-32 lg:py-52 md:py-52">
                    <h1 className="text-6xl font-bold text-sky-500 pb-8">FOUNDERS</h1>
                    <div className="grid place-items-center">
                        <div className="flex flex-wrap xl:w-2/3 w-11/12 justify-center gap-12 py-8">
                            {Found}
                        </div>
                    </div>
                </div>
                ...
                <div className="text-center py-12">
                    <h1 className="text-5xl font-bold pb-10">TEAM 2022</h1>
                    <div className="grid place-items-center">
                        <div className="flex flex-wrap xl:w-1/2 w-11/12 justify-center gap-12 py-8">
                            {T2022}
                        </div>
                    </div>
                </div>
                {/* TEAM 2023 */}
                <div className="text-center py-12">
                    <h1 className="text-5xl font-bold pb-10">TEAM 2023</h1>
                    <div className="grid place-items-center">
                        <div className="flex flex-wrap xl:w-1/2 w-11/12 justify-center gap-12 py-8">
                            {T2023}
                        </div>
