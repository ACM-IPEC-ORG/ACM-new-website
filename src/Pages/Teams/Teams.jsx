        ...
        <div>
            ...
            <div className="">
                ...
                <div className="grid xl:grid-cols-2 lg:grid-cols-1 xl:px-64 lg:px-10 pt-12">
                    ...
                    <div className="grid md:grid-flow-col scale-75 md:grid-cols-3 grid-cols-1 place-items-center">
                        {HEADsD}
                    </div>
                </div>
                </section>
                ...
                <div className="grid grid-cols-1 place-items-center px-24 pt-12">
                    ...
                    <div className="grid md:grid-flow-col scale-75 md:grid-cols-2 grid-cols-1 justify-evenly xl:px-64 lg:px-12 md:gap-12 px-10 py-8">
                        {Conveyer}
                    </div>
                </div>
                {/* PM */}
